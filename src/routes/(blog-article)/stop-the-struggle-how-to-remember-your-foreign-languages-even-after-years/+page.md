...
<KeyTakeaways items={[
  "A language you stop using fades, but knowledge only needs maintenance to stay strong.",
  "Words fade faster than grammar or pronunciation, and understanding outlasts speaking.",
  "Anyone can forget; children forget faster and more completely than adults.",
  "Passion, solid proficiency, a reason to use the language and a community protect it.",
  "Relearning is always faster than starting from scratch."
]} />
...
<Steps
  steps={[
    { title: "Passion", text: "Loving a language helps lock it into your brain." },
    { title: "Proficiency", text: "The stronger your initial learning, the more resistant it is to fading." },
    { title: "Motivation", text: "Having a reason to use the language (work, travel, friends) acts as a powerful retention booster." },
    { title: "Community", text: "Surrounding yourself with the language keeps it active in your life." }
  ]}
/>
...
<AppDemo
  screen="chat"
  title="Keep a language in use"
  text="A LangX chat with someone who speaks the language you are learning. Your partner can hold any message to correct it, so a rusty phrase gets fixed in the conversation."
/>
