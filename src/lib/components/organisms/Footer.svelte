			...
			<div class="links-container">
				<div class="right">
					<div>
						...
						<ul role="list">
							<li>
								<a href="https://app.gitbook.com/invite/0n6eGkPoppmsyoZuw2GO/I9eV3C08ufDq2xWLjeVn" target="_blank">Whitepaper</a>
							</li>
							<li>
					...
					<div>
						...
						<ul role="list">
							...
							<li>
								<a href="https://play.google.com/store/apps/details?id=tech.newchapter.languageXchange" target="_blank">Android</a>
							</li>
							<li>
								<a href="https://apps.apple.com/us/app/langx-practice-learn-succeed/id6474187141" target="_blank">iOS</a>
							</li>
						</ul>
					</div>
				</div>
